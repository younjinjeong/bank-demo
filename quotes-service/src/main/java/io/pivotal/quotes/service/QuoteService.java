...
public class QuoteService {
    ...
    public List<CompanyInfo> getCompanyInfo(String symbol) {
        ...
        ResponseEntity<String> response
                = restTemplate.getForEntity(company_url, String.class, params);

        ObjectMapper mapper = new ObjectMapper();

        JsonObject companyResponse = gson.fromJson(response.getBody(), JsonObject.class);
        CompanyInfo companyInfo = new CompanyInfo();
        companyInfo.setName(companyResponse.get("companyName").getAsString());
        companyInfo.setSymbol(companyResponse.get("symbol").getAsString());
        companyInfo.setExchange(companyResponse.get("exchange").getAsString());
